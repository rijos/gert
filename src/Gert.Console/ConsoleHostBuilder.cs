...
public static class ConsoleHostBuilder
{
    ...
    /// <see cref="Gert.Service.ServiceCollectionExtensions.AddGertServices"/>, the storage seam
    ...
    /// <see cref="Gert.Service.ServiceCollectionExtensions.AddGertServices"/> — the Console does
        ...
        IConfiguration configuration)
    {
        ...
        // Storage seam (storage-and-data.md § lazy provisioning) — the SAME
        // AddGertSqliteStorage the Api host calls (dotnet-style-guide.md §4),
        // so the two hosts cannot drift.
        services.AddGertSqliteStorage(configuration);
