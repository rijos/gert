...
/// <c>ToolCallTimeout</c> backstop (a delegated research task legitimately
...
/// </para>
/// </summary>
public sealed class SubAgentTool : ITool, IInteractiveTool
{
    ...
    /// <inheritdoc />
    public string Id => "sub_agent";

    /// <inheritdoc />
    public string Name => "run_sub_agent";
