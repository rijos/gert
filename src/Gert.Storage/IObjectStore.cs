...
/// <see cref="Database.IChatDatabaseProvider"/>) and the RAG index capability
/// (<c>Gert.Rag.IRagIndexProvider</c>).
/// </para>
///
/// <para>
...
public interface IObjectStore
{
    ...
    /// (locally: a recursive directory delete; cloud: delete-by-prefix). The
