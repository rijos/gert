...
/// friendly model of the SSE event table (rest-api.md section sending a message).
/// The chat service yields these as an <c>IAsyncEnumerable&lt;ChatEvent&gt;</c>;
/// the Api renders each as an SSE <c>event:/data:</c> frame - transport never
/// leaks into the service (tech-stack.md section Architecture).
/// <para>
