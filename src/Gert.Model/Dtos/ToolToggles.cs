...
/// (rest-api.md section sending a message; storage-and-data.md section chat.db). A generic,
...
/// (auth.md section entitlement). Tool ids are validated against the <c>ToolRegistry</c>
