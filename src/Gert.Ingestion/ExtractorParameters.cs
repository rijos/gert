...
/// <summary>
/// Resource caps + hardening knobs for the isolated PDF/DOCX extractor (the <c>Parameters</c>
/// bag of <see cref="ExtractorOptions"/>, bound from <c>Gert:Extractor:Parameters</c>; security
/// F7). All non-secret. The defaults are the locked-down posture: capped address space / CPU /
/// process count, a wall-clock kill, no network, DTD/external-entities off, and
/// decompressed-size + zip-entry caps for the DOCX zip.
/// </summary>
public sealed class ExtractorParameters
{
