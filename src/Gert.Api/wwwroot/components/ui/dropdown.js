...
export const Dropdown = component({
  ...
  css: `
    ...
    .dd-btn{display:flex; align-items:center; gap:8px; width:100%; padding:9px 12px; border:1px solid var(--line-strong); background:var(--surface); border-radius:var(--r-sm); cursor:pointer; font-family:var(--sans); font-weight:500; font-size:13.5px; color:var(--ink); transition:.14s; text-align:left;}
    .dd-btn:hover{border-color:var(--accent); background:var(--accent-soft);}
    .dd-btn .dd-label{flex:1; min-width:0; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;}
    .dd-btn .chev{width:13px; height:13px; color:var(--ink-faint); transition:.2s; flex:none;}
    ...
    .dd-search{width:100%; font-family:var(--sans); font-size:13px; color:var(--ink); background:var(--inset); border:1px solid var(--line); border-radius:var(--r-sm); padding:7px 10px; margin-bottom:5px;}
    ...
    .dd-item:hover{background:var(--inset);}
    .dd-item.sel{background:var(--accent-soft); color:var(--accent-deep); font-weight:600;}
    .dd-empty{padding:8px 10px; font-size:12.5px; color:var(--ink-faint);}
  `,
  view: ({
    items,
    value,
