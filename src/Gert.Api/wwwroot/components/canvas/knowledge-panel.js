...
export const KnowledgePanel = component({
  ...
  css: `
    ...
    .privacy{font-family:var(--mono); font-size:var(--fs-2xs); color:var(--coral-deep); display:flex; align-items:center; gap:5px; margin-top:7px;}
    .privacy svg{width:11px; height:11px;}
    .usein{margin:11px 18px 4px; display:flex; align-items:center; gap:10px; padding:10px 12px; background:var(--coral-soft); border:1px solid var(--coral-line); border-radius:var(--r-sm);}
    .usein .lab{font-size:var(--fs-sm); font-weight:600; color:var(--coral-deep); flex:1;}
    .usein .sub{font-size:var(--fs-2xs); color:var(--ink-2); font-weight:400;}
