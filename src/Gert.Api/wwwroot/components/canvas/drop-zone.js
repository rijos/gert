...
export const DropZone = component({
  name: "drop-zone",
  css: `
    .dropzone{margin:13px 18px; border:1.5px dashed var(--line); border-radius:var(--r); padding:18px 14px; text-align:center; color:var(--ink-3); cursor:pointer; transition:var(--t-fast);}
    ...
    .dropzone .dz1{font-size:var(--fs-sm); font-weight:600; color:inherit;}
    .dropzone .dz2{font-family:var(--mono); font-size:var(--fs-2xs); margin-top:3px;}
  `,
  view: () => {
