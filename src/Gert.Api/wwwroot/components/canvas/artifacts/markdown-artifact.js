...
export const MarkdownArtifact = component({
  ...
  css: `
    ...
    .md-render h1{font-family:var(--display); font-weight:600; font-size:var(--fs-xl); letter-spacing:-.01em; margin:0 0 4px;}
    .md-render h2{font-family:var(--display); font-weight:600; font-size:var(--fs-lg); margin:22px 0 8px; padding-bottom:5px; border-bottom:1px solid var(--line);}
    .md-render h3{font-family:var(--display); font-weight:600; font-size:var(--fs-md); margin:18px 0 6px;}
    .md-render p{font-size:var(--fs-md); line-height:var(--lh-reading); color:var(--ink); margin:0 0 12px;}
    .md-render ul,.md-render ol{margin:0 0 13px; padding-left:20px;}
    .md-render li{font-size:var(--fs-md); line-height:var(--lh-reading); margin-bottom:5px;}
    ...
    .md-render code{font-family:var(--mono); font-size:var(--fs-sm); background:var(--surface-2); border:1px solid var(--line); border-radius:4px; padding:1px 5px;}
    .md-render pre{background:var(--code-bg); color:var(--code-fg); border-radius:var(--r-sm); padding:13px 16px; margin:0 0 14px; overflow-x:auto;}
    .md-render pre code{background:none; border:none; padding:0; color:inherit; font-size:var(--fs-sm);}
    ...
    .md-render table{border-collapse:collapse; width:100%; margin:0 0 14px; font-size:var(--fs-sm);}
    .md-render th{text-align:left; font-family:var(--mono); font-size:var(--fs-2xs); letter-spacing:.04em; text-transform:uppercase; color:var(--ink-3); padding:7px 10px; border-bottom:1.5px solid var(--line);}
  ...
  div(
    ...
    div(
      ...
      div({ class: "source-view" }, () =>
        MdCode({ code: artifact.content || "", lang: "md" }),
      ),
    ),
  ),
});
