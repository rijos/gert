...
const ArtifactHead = ({ artifact, mode, code = false } = {}) =>
  div(
    { class: "art-head" },
...
export const Artifact = component({
  ...
  css: `
    ...
    .atype.md{background:var(--type-md);} .atype.html{background:var(--coral);} .atype.svg{background:var(--amber);} .atype.py{background:var(--type-py);}
