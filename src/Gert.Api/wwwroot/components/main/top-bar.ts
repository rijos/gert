...
export const TopBar = component({
  ...
  view: () =>
    div({ class: "topbar" },
      button({ class: "ghost collapse-btn", title: "Toggle sidebar", "aria-label": "Toggle sidebar", onclick: ui.toggleNav },
        Icon("sidebar", { strokeWidth: 2 }),
      ),
      ConvTitle(),
      ThemeToggle(),
      ModelPicker(),
      button({ class: "ghost", title: "Toggle knowledge panel", "aria-label": "Toggle knowledge panel", onclick: ui.togglePanel },
