...
export const ToolsMenu = component({
  ...
  css: `
    ...
    .tools-menu .tcount{min-width:16px; height:16px; padding:0 4px; border-radius:9px; background:var(--coral-soft); color:var(--coral-deep); font-family:var(--mono); font-size:var(--fs-2xs); font-weight:600; display:grid; place-items:center;}
