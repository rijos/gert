...
// a tool card (chat-and-tools.md § Ask the user): the question text, one
...
export const QuestionCard = component({
  ...
  css: `
    ...
    .qcard .qopt.chosen{border-color:var(--green-line); background:var(--green-soft); color:var(--green); opacity:1;}
    ...
    .qcard .qanswer{font-family:var(--mono); font-size:12px; color:var(--green); margin-top:2px;}
