...
export const ConvTitle = component({
  ...
  css: `
    ...
    .title-input{width:100%; font-family:var(--display); font-size:var(--fs-lg); font-weight:500; letter-spacing:-.01em; line-height:inherit; color:var(--ink); background:none; border:none; border-radius:0; padding:0; margin:0; outline:none; box-shadow:0 1px 0 var(--coral);}
  `,
  view: () => {
    // -- logic -----------------------------------
