...
/// <summary>
/// Real <see cref="IWebSearch"/> over the SearXNG JSON API (chat-and-tools.md § web
...
/// instance and network (U13 mock + staging). Unit tests cover the response parsing and
