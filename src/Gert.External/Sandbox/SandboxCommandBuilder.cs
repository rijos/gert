...
public static class SandboxCommandBuilder
{
    ...
    /// </summary>
    public static IReadOnlyList<string> BuildRunscArgs(PythonSandboxOptions options, string containerId, string bundlePath)
    {
    ...
    /// </summary>
    public static SandboxRuntimeConfig BuildRuntimeConfig(PythonSandboxOptions options, string code)
    {
        ArgumentNullException.ThrowIfNull(options);
