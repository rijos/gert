...
/// section sandbox; security F5). Bound from configuration section <c>Gert:Sandbox</c>. All
/// non-secret. The defaults are the security posture: <b>egress off</b>, read-only
/// rootfs, no <c>/data</c> mount, hard mem/wall caps.
///
/// <para>
/// Two backends sit behind the one <see cref="Gert.Service.External.IPythonSandbox"/> port,
