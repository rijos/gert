...
/// storage-and-data.md section lazy provisioning). The host (<c>Gert.Api</c>)
/// calls this in place of a copy-pasted registration block. Everything is
/// <c>TryAdd</c>, so a host or test may
...
public static class ServiceCollectionExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        // Options bind via the section 4 idiom (dotnet-style-guide.md): fail at startup,
        ...
        // structured config lives in user.db - storage-and-data.md section "No JSON
