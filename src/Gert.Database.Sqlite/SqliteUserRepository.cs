...
/// (storage-and-data.md section user.db). Wraps a single open connection opened by the
...
public sealed class SqliteUserRepository : IUserRepository
{
    ...
    /// injected (dotnet-style-guide.md section 5) so tests can pin <c>created_at</c>.
    /// </summary>
