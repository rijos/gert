...
public sealed class MakeArtifactTool : ITool
{
    ...
    public string Description =>
        "Create a complete, self-contained file that opens in the user's canvas (an HTML "
        + "page, a script, a Markdown document, an SVG, etc.). ALWAYS use this instead of "
        + "putting a whole file in a code block. Pass the entire file content. Re-using a "
        + "name overwrites that artifact; to change one part of an existing artifact use "
        + "edit_artifact instead of remaking the whole file.";
