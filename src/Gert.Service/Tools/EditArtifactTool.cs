...
public sealed class EditArtifactTool : ITool
{
    ...
    public string Description =>
        "Edit an existing canvas artifact by replacing an exact snippet with new text — "
        + "use this to change part of a file instead of remaking the whole thing. old_str "
        + "must appear EXACTLY ONCE (copy it verbatim, including indentation); if it isn't "
        + "unique, include more surrounding lines. Use read_artifact first if unsure of the "
        + "current content.";
