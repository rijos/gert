...
/// <summary>
/// The ask-user tool (chat-and-tools.md § Ask the user). Model function
...
public sealed class AskUserTool : ITool, IInteractiveTool
{
    ...
    public string Description =>
        "Ask the user ONE clarifying question and wait for their answer before continuing. "
        + "Use only when you genuinely cannot proceed without input. Offer options when the "
        + "choice is closed. The user may not respond — if the result says they did not, "
        + "continue with your best judgement.";
