...
/// <summary>
/// The web-fetch tool (chat-and-tools.md § web fetch). Model function
...
/// error), never a turn fault. The body is returned raw and clipped — no text
/// extraction, parity with the search summarize step.
/// </summary>
public sealed class WebFetchTool : ITool
{
    ...
    public string Description =>
        "Fetch one public web page by URL and return its raw content (clipped). "
        + "Use it to read a page a search result or the user pointed at. Private, "
        + "internal, and non-http(s) addresses are refused by policy.";
