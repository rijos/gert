...
/// <summary>
/// The save-memory tool (chat-and-tools.md § save memory). Model function
...
public sealed class SaveMemoryTool : ITool
{
    ...
    public string Description =>
        "Save ONE durable fact or preference the user states for future conversations "
        + "in this project. Each call creates a new entry — never re-save something you "
        + "already saved this conversation; keep it short.";
