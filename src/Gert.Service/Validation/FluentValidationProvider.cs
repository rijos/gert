...
/// replaces the U6-TODO passthrough). It resolves the FluentValidation
...
/// shape so the API renders a 400 ProblemDetails and the Console prints the same
/// errors (testing.md § the provider contract).
/// <para>
