...
/// (chat-and-tools.md § ingestion: "md/txt → read"). One <see cref="ExtractedPage"/>
...
/// <c>Gert.External</c> in U10. Until then a composite extractor falls through to a
/// "needs U10 extractor" failure for those types.
/// </para>
/// </summary>
