...
/// <summary>
/// Database-agnostic options for the storage layer (storage-and-data.md section layout /
...
public sealed class StorageOptions
{
    ...
    /// (storage-and-data.md section layout). Every per-user folder lives under
