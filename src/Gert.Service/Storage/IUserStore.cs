...
/// <summary>
/// The user/project <b>blob lifecycle</b> seam (storage-and-data.md section layout). Now
...
public interface IUserStore
{
    ...
    /// <c>default</c>-project path (configuration.md section 5): the landing project is
