...
/// docs/design/tech-stack.md § Architecture: the host-agnostic service layer
/// must never depend on a host or adapter. This is the structural guarantee
/// that lets Gert.Console drive the services without Gert.Api — compiler- and
/// test-enforced from day one (U0).
/// </summary>
