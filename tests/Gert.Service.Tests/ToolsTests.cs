...
/// <see cref="StubPythonSandbox"/>) and an NSubstitute <see cref="IRagRepository"/>.
/// </summary>
public sealed class ToolsTests
{
    ...
    {
        var tool = new PythonSandboxTool(StubPythonSandbox.WithStdout("4\n"));
    ...
    {
        var tool = new PythonSandboxTool(StubPythonSandbox.ThatFails("Traceback: boom", exitCode: 1));
    ...
    {
        var tool = new PythonSandboxTool(StubPythonSandbox.ThatThrows(new InvalidOperationException("runsc spawn failed")));
    ...
    {
        var tool = new PythonSandboxTool(StubPythonSandbox.ThatTimesOut());
