...
/// <summary>
/// The adversarial input corpus (testing.md §5 threat table). One shared set fed
...
public static class NaughtyStrings
{
    ...
    private static readonly string CyrillicA = ((char)0x0430).ToString();    // Cyrillic small 'а'
    ...
    [
        CyrillicA + "dmin",                  // Cyrillic 'а' (U+0430), not Latin 'a'
