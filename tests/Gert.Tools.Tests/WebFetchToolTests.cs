...
public sealed class WebFetchToolTests
{
    ...
    {
        var tool = new WebFetchTool(new FakeWebFetcher());
    ...
    {
        var tool = new WebFetchTool(FetcherReturning(
    ...
    {
        var tool = new WebFetchTool(FetcherReturning("{\"version\":\"1.2.3\"}"));
    ...
    {
        var tool = new WebFetchTool(FetcherReturning(new string('x', 100)));
    ...
    {
        var tool = new WebFetchTool(FetcherReturning(new string('y', WebFetchTool.DefaultMaxChars + 5)));
    ...
    {
        var tool = new WebFetchTool(FetcherReturning(new string('z', WebFetchTool.MaxCharsCeiling + 5)));
    ...
    {
        var tool = new WebFetchTool(Substitute.For<IWebFetcher>());
