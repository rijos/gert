...
/// <summary>
/// Best-effort readiness probe behind <c>/readyz</c> (operations.md § Observability):
...
public static class ReadinessCheck
{
        ...
        IHttpClientFactory httpFactory, CancellationToken cancellationToken)
    {
        ...
        var vllm = ProbeAsync(httpFactory, VllmChatModelClient.HttpClientName, cancellationToken);
        ...
        {
            [VllmChatModelClient.HttpClientName] = vllm.Result,
