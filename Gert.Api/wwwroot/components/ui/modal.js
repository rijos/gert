...
export const Modal = component({
  ...
  css: `
    ...
    .modal{background:var(--surface); border:1px solid var(--line-strong); border-radius:var(--r); box-shadow:0 24px 60px -20px rgba(60,46,28,.5); padding:20px 22px; width:min(440px,calc(100vw - 32px)); animation:rise .26s cubic-bezier(.2,.8,.2,1) backwards; position:relative;}
    ...
    .modal .ver{font-family:var(--mono); font-size:10px; color:var(--ink-faint); letter-spacing:.02em; margin-top:14px;}
  `,
  view: ({
    title,
    body,
