"""test_chat.py - new chat -> send -> streaming -> tool cards -> citations (section 9).
...
def test_reload_during_generation_resumes(page: Page, base_url: str) -> None:
    # THE headline of the detached turn pipeline (chat-and-tools.md section detached
...
def test_tool_call_renders_tool_card(page: Page, base_url: str) -> None:
    ...
    # The rag tool fixture emits a tool call -> a .tcard renders (behind the
    # message's activity dropdown), then final text.
