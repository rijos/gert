...
testing.md section 4.3: Python mints the tokens; the Fake host only *trusts* a dev key
...
ROLES: dict[str, dict[str, Any]] = {
    ...
    # standard non-admin; sandbox denied.
    "user": {
        "sub": "dev-user",
        "groups": ["gert-users"],
        "gert_tools": "rag search ask_user fetch sub_agent",
    },
