// render.mjs - the headless entry point. Installs the DOM shim, registers the
...
// load, so consumers just `import { renderMarkdown } from "./lib/render.mjs"`.
...
export const importWww = (spec) => import(spec.startsWith("/") ? spec : "/" + spec);
