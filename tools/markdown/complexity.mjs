// complexity.mjs - systematic SUPER-LINEAR growth probe (ReDoS + amplification).
//
// fuzz.mjs uses a per-input time threshold, which catches a SLOW input but not a
