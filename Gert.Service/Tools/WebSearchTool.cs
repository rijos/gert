...
/// <summary>
/// The web-search tool (chat-and-tools.md § web search). Model function
/// <c>web_search</c>: forwards the query to <see cref="IWebSearch"/> (SearXNG +
/// the SSRF-guarded fetch lives behind the port, security F5 / U10) and shapes
...
public sealed class WebSearchTool : ITool
{
    ...
    public string Description =>
        "Search the public web (via SearXNG) and return the most relevant results "
