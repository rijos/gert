...
/// unhandled type (pdf/docx until U10's isolated-subprocess extractor, security F7)
...
///
/// <para>
/// U10 swaps in the hardened pdf/docx extractor by registering it as another
...
public sealed class CompositeTextExtractor : ITextExtractor
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // pdf/docx until U10: no extractor available for this type yet.
        return Task.FromResult(
            ExtractionResult.Failed($"extractor not available for '.{extension}' (deferred to U10)"));
    }
}
