...
/// <summary>
/// The text-extraction port — ingestion step 1 (chat-and-tools.md § ingestion).
...
///   <c>Gert.External</c> in U10; until then those types return
///   <see cref="ExtractionResult.Failed"/> and the doc is marked <c>failed</c>.</item>
/// </list>
/// Keeping extraction behind this port lets U10 swap the hardened extractor in with
